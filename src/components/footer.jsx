    ...
    return (
        ...
        <div>
            <ul className="text-gray-500  space-y-3.5">
                ...
                <li>Blog</li>
                <li>Customers</li>
                <li className="">Careers <span className="ml-2 text-sm border border-teal-400/60 w-[100px] rounded-full px-[10px] py-[3px] bg-teal-400/10 text-teal-400">Hiring</span></li>
            </ul>
        </div>
