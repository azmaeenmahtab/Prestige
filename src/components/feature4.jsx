              ...
              <div className="max-w-[1280px] mx-auto flex flex-col md:flex-row justify-between items-center gap-8 px-[40px] aiContent1000">
                <div className="text-left max-w-[560px] pt-5 increaseAiWidth1000">
                  ...
                  <p className=" text-gray-400">Designed to seamlessly integrate into your personal and professional life, our AI Assistant is here to revolutionize the way you accomplish tasks.</p>
                    ...
                    {/* learn more button */}
                  <div className="flex justify-start items-center w-[155px]">
                  <button className="mt-[50px] text-white bg-[#171923] rounded-full px-6 py-4 border border-gray-400/40 cursor-pointer hover:bg-gray-200/15 transition-all w-[155px]">
                    Learn more
